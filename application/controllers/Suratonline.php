...
class Suratonline extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['options'] = [
            'Pilih',
            'Surat Pengantar:'   => [
                'SPKTPBW'        => '- KTP-el Baru WNI',
                'SPKTPP'         => '- KTP-el Baru karena Pindah atau Perubahan Data',
                'SPKTPRH'        => '- KTP-el Baru karena Rusak atau Hilang',
                'SPKTPOA'        => '- KTP-el Baru untuk OA',
                'SPKTPPOA'       => '- KTP-el Baru karena Pindah atau Perubahan Data OA',
                'SPKTPRHOA'      => '- KTP-el Baru karena Rusak atau Hilang OA',
                'SPKK'           => '- Kartu Keluarga Baru karena Membentuk keluarga Baru',
                'SPKKPK'         => '- Kartu Keluarga Baru karena Pergantian Kepala keluarga (Kematian Kepala keluarga)',
                'SPKKPKK'        => '- Kartu Keluarga Baru karena Pisah KK dalam 1 Alamat',
                'SPKKPD'         => '- Kartu Keluarga Baru karena Perubahan Data',
                'SPKKHR'         => '- Kartu Keluarga Baru karena Hilang atau rusak',
                'SKP'            => '- Pindah',
                'SKD'            => '- Datang',
                'SK'             => '- Skck',
                'SPAW'           => '- legalisir'
