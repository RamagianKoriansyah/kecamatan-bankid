...
<body>
	<div class="wrapper">
		<div class="sidebar" data-active-color="green" data-background-color="black" data-image="<?= base_url() ?>/assets/img/gs.jpg">
			<!--
    ...
    -->
			...
			<div class="sidebar-wrapper">
				<?php if ($this->session->userdata('id_user') == TRUE) : ?>
					<div class="user">
						<div class="photo">
							<img src="<?= base_url() ?>/assets/img/bankid.png" />
						</div>
						<div class="info">
							...
							<ul class="nav">
                                ...
                                ">
									<a href="<?= base_url() ?>surat/pengajuan">
										...
										<span class="sidebar-normal">Surat Pengajuan</span>
									</a>
								</li>
								<li class="
                                ...
                                ">
									<a href="<?= base_url() ?>surat/surat_keterangan">
										<span class="sidebar-mini">SKT</span>
