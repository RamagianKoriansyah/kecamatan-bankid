...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url() ?>assets/img/logobandung.png" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <title>Login Sistem Pelayanan Penduduk Kecamatan Bandung Kidul</title>
...
<body class="off-canvas-sidebar">
    <nav class="navbar navbar-primary navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=" ../dashboard.html ">Sistem Pelayanan Penduduk Kecamatan Bandung Kidul</a>
            </div>
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="black" data-image="<?= base_url() ?>assets/img/kecamatan.jpg">
            ...
            <footer class="footer">
                <div class="container">
                    ...
                    <p class="copyright pull-right">
                        ...
                        <a href="#">Team IT Bandung Kidul</a>, Copyright
                    </p>
                </div>
            </footer>
        </div>
