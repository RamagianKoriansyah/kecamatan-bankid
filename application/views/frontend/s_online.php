<section class="page-section">
    <div class="container">
        ...
        <div class="text-center">
            <h2 class="section-heading text-uppercase">Pengajuan Pelayanan Online</h2>
            <h3 class="section-subheading text-muted">Isi Form Pengajuan Pelayanan Dibawah:</h3>
        </div>
        <div class="text-justify pl-5 pr-5">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <?= form_input(['name' => 'nik', 'id' => 'nik', 'class' => 'form-control', "required" => "required", 'placeholder' => 'Silahkan masukkan NIK / No KK anda']); ?>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6 mt-2">
                    <label for="jenis">Pilih Jenis Pelayanan *</label>
